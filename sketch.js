...
function preload(){
  //loading images
  backgroundimg1 = loadImage("images/floor 2.jpg");
  ...
  slow = loadSound("sounds/harry_potterslow.mp3");
  normal = loadSound("sounds/harry_potterfast.mp3");
  fast = loadSound("sounds/harry_potterextrafast.mp3"); 
